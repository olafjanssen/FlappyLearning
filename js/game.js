...
GameManager.prototype.start = function () {
    ...
    console.log('next generation created', this.gen);
    this.generation++;

    this.game = new Game();
    this.game.update();
    //    if (maxScore > 30000 && !isDisplay) {
    //        FPS = 60;
    //        isDisplay = true;
    this.game.display();
    //    }
...
Game.prototype.start = function (boids) {
    this.interval = 0;
    this.score = 0;
    this.pipes = [];
    this.birds = [];
...
Game.prototype.display = function () {
    ...
    this.ctx.fillText("Generation : " + gamemanager.generation, 10, 75);
    this.ctx.fillText("Boid : " + gamemanager.gen.length + " / " + Neuvol.options.population, 10, 100);
